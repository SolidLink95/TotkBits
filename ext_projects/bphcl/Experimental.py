...
class hclSimClothData(hkReferencedObject):
    ...
    def from_reader(cls, stream: ReadStream) -> "hclSimClothData":
        ...
        m_fixedParticles = hkArray.from_reader(stream, u16) # padding TODO: check if this is correct
        m_doNormals = stream.read_bool()
        m_simOpIds = hkArray.from_reader(stream, u32)
        m_simClothPoses = hkArray.from_reader(stream, hkRefPtr, hclSimClothPose) # padding TODO: check if this is correct
