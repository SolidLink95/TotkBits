...
pub struct OpenedFile<'a> {
    ...
    pub bphsh: Option<crate::file_format::bphsh::BphshFile>,
    pub bphhb: Option<crate::file_format::bphhb::BphhbFile>,
    pub bphyssb: Option<crate::file_format::bphyssb::BphyssbFile>,
    pub hkcl: Option<crate::file_format::hkcl::HkclFile>,
    pub hkrg: Option<crate::file_format::hkrg::HkrgFile>,
