...
impl<'a> Icons<'_> {
    pub fn new(size: &Vec2) -> Self {
        Self {
            ...
            add_sarc: egui::Image::new(include_image!("../icon/add_sarc.png")).fit_to_exact_size(*size),
            ...
            save_as: egui::Image::new(include_image!("../icon/save_as.png")).fit_to_exact_size(*size),
