...
const documentCommands = new Set([
    ...
    'add_click', 'add_archive_bytes', 'add_to_dir_click', 'add_files_from_dir_recursively',
    ...
    'clear_search_in_sarc', 'clear_rfl_miis', 'compare_files', 'compare_internal_file_with_vanila',
    ...
    'replace_g1m_meshes', 'list_batch_render_files',
